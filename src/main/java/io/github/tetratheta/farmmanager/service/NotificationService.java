...
public final class NotificationService {
  ...
  public NotificationService(
      MessageService messageService, MessageChannel channel, int chatCooldownTicks) {
  ...
  ///
  /// Chat notifications are throttled because they can flood history. Action bar notifications
  /// are transient, so they are sent every time.
  ///
